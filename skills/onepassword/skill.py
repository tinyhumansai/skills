"""
1Password SkillDefinition — wires setup, tools, and lifecycle hooks
into the unified SkillServer protocol.

Usage:
    from skills.onepassword.skill import skill
"""
...
log = logging.getLogger("skill.onepassword.skill")
...
async def _on_load(ctx: Any) -> None:
  """Initialize 1Password client using SkillContext."""
...
async def _on_disconnect(ctx: Any) -> None:
  """Close 1Password connections and clear credentials."""
  from .server import on_skill_unload
...
skill = SkillDefinition(
  name="onepassword",
  description="Access credentials from local 1Password vault using the 1Password CLI. List items, get passwords, retrieve fields, and search for credentials. Requires 1Password CLI (op) to be installed and authenticated.",
  version="1.0.0",
  has_setup=True,
  has_disconnect=True,
