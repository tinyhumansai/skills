...
class OnePasswordClient:
  ...
  def list_items(self, vault: str | None = None, categories: list[str] | None = None) -> list[dict[str, Any]]:
    """List items in vault."""
  ...
  def get_item(self, item_id: str | None = None, item_name: str | None = None, vault: str | None = None) -> dict[str, Any]:
  ...
  def get_field(self, item_id: str | None = None, item_name: str | None = None, field_label: str | None = None, vault: str | None = None) -> str:
  ...
  def get_password(self, item_id: str | None = None, item_name: str | None = None, vault: str | None = None) -> str:
